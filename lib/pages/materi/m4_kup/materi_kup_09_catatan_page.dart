...
class MateriKUP09Page extends StatefulWidget {
  const MateriKUP09Page({super.key});

  @override
  State<MateriKUP09Page> createState() => _MateriKUP09PageState();
}

class _MateriKUP09PageState extends State<MateriKUP09Page> {
                                                          ...
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              ...
                                                              children: <TextSpan>[
                                                                TextSpan(
                                                                  text:
                                                                      "Ringkasan ini hanya memuat informasi dasar tentang pajak.",
                                                                ),
                                                              ],
                                                            ),
                                                          ),
                                                          ...
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              ...
                                                              children: <TextSpan>[
                                                                TextSpan(
                                                                  text:
                                                                      "Untuk informasi yang lebih lengkap, Anda dapat merujuk pada undang-undang dan peraturan perpajakan yang terkait.",
                                                                ),
                                                              ],
                                                            ),
                                                          ),
                    ...
                    Container(
                      ...
                      child: Container(
                        ...
                        child: FractionallySizedBox(
                          ...
                          widthFactor: 9 / 9, // 20% width of parent
