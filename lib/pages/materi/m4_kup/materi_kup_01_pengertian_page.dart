...
class MateriKUP01Page extends StatefulWidget {
  const MateriKUP01Page({super.key});

  @override
  State<MateriKUP01Page> createState() => _MateriKUP01PageState();
}

class _MateriKUP01PageState extends State<MateriKUP01Page> {
  @override
                                        ...
                                        child: RichText(
                                          ...
                                          text: TextSpan(
                                            ...
                                            children: <TextSpan>[
                                              ...
                                              TextSpan(
                                                text:
                                                    " kepada negara yang bersifat memaksa berdasarkan undang-undang, dengan tujuan untuk memperoleh ",
                                              ),
                                              TextSpan(
                                              ...
                                              RichText(
                                                ...
                                                text: TextSpan(
                                                  ...
                                                  children: <TextSpan>[
                                                    TextSpan(
                                                      text:
                                                          "Pajak digunakan untuk membiayai berbagai pengeluaran negara, seperti pembangunan infrastruktur, pendidikan, kesehatan, dan pertahanan.",
                                                    ),
                                                  ],
                                                ),
                                              ),
