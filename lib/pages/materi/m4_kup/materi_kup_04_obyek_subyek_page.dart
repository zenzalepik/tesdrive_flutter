...
class MateriKUP04Page extends StatefulWidget {
  const MateriKUP04Page({super.key});

  @override
  State<MateriKUP04Page> createState() => _MateriKUP04PageState();
}

class _MateriKUP04PageState extends State<MateriKUP04Page> {
  @override
                    ...
                    Row(
                      ...
                      children: [
                        MarkSubtitle(
                            ...
                            text: "04. Obyek dan Subyek Pajak")
                      ],
                    ),
                    Row(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    text:
                                                                      ...
                                                                      children: <TextSpan>[
                                                                        TextSpan(
                                                                          text:
                                                                              "Obyek pajak adalah hal atas mana pajak dikenakan. Obyek pajak dapat berupa barang, jasa, atau kejadian.",
                                                                        ),
                                                                      ],
                                                                    ),
                                                                  ),
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    text:
                                                                      ...
                                                                      children: <TextSpan>[
                                                                        TextSpan(
                                                                          text:
                                                                              "Subyek pajak adalah orang pribadi atau badan yang wajib membayar pajak.",
                                                                        ),
                                                                      ],
                                                                    ),
                                                                  ),
