...
import 'package:belajar_sistem_pajak/pages/materi/m4_kup/materi_kup_09_catatan_page.dart';
...
class MateriKUP08Page extends StatefulWidget {
  const MateriKUP08Page({super.key});

  @override
  State<MateriKUP08Page> createState() => _MateriKUP08PageState();
}

class _MateriKUP08PageState extends State<MateriKUP08Page> {
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.of(context).pushReplacement(
                              MaterialPageRoute(
                                builder: (context) => MateriKUP09Page(),
                              ),
                            );
                          },
                          child: SvgPicture.asset(
