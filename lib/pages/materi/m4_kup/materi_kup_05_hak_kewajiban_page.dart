...
class MateriKUP05Page extends StatefulWidget {
  const MateriKUP05Page({super.key});

  @override
  State<MateriKUP05Page> createState() => _MateriKUP05PageState();
}

class _MateriKUP05PageState extends State<MateriKUP05Page> {
  @override
                    ...
                    Row(
                      ...
                      children: [
                        MarkSubtitle(
                            ...
                            text: "05. Hak dan Kewajiban Perpajakan")
                      ],
                    ),
                    Row(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    text:
                                                                      ...
                                                                      children: <TextSpan>[
                                                                        TextSpan(
                                                                          text:
                                                                              "Hak untuk mendapatkan pelayanan yang baik dari DJP.",
                                                                        ),
                                                                      ],
                                                                    ),
                                                                  ),
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    text:
                                                                      ...
                                                                      children: <TextSpan>[
                                                                        TextSpan(
                                                                          text:
                                                                              "Hak untuk memperoleh restitusi atau kelebihan pembayaran pajak.",
                                                                        ),
                                                                      ],
                                                                    ),
                                                                  ),
