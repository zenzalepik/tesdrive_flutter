...
import 'package:belajar_sistem_pajak/pages/materi/m3_pph/materi_pph_08_sumber_page.dart';
...
class MateriPPh07Page extends StatefulWidget {
  const MateriPPh07Page({super.key});

  @override
  State<MateriPPh07Page> createState() => _MateriPPh07PageState();
}

class _MateriPPh07PageState extends State<MateriPPh07Page> {
  @override
                                                          ...
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              ...
                                                              children: <TextSpan>[
                                                                TextSpan(
                                                                  text:
                                                                      "Perhitungan PPh di atas hanya merupakan contoh.",
                                                                ),
                                                              ],
                                                            ),
                                                          ),
                                                          ...
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              ...
                                                              children: <TextSpan>[
                                                                TextSpan(
                                                                  text:
                                                                      "Perhitungan PPh yang sebenarnya dapat lebih kompleks, tergantung pada jenis PPh, tarif PPh, dan faktor-faktor lainnya.",
                                                                ),
                                                              ],
                                                            ),
                                                          ),
                    ...
                    Container(
                      ...
                      child: Container(
                        ...
                        child: FractionallySizedBox(
                          ...
                          widthFactor: 7/8, // 20% width of parent
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.of(context).pushReplacement(
                              MaterialPageRoute(
                                builder: (context) => MateriPPh08Page(),
                              ),
                            );
                          },
                          child: SvgPicture.asset(
