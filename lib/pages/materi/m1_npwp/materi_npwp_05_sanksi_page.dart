...
class MateriNpwp05Page extends StatefulWidget {
  const MateriNpwp05Page({super.key});

  @override
  State<MateriNpwp05Page> createState() => _MateriNpwp05PageState();
}

class _MateriNpwp05PageState extends State<MateriNpwp05Page> {
  @override
                    ...
                    Row(
                      ...
                      children: [
                        MarkSubtitle(
                            ...
                            text: "05. Sanksi Terkait Kepemilikan NPWP")
                      ],
                    ),
                    Row(
                                                          ...
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              ...
                                                              children: <TextSpan>[
                                                                TextSpan(
                                                                  text:
                                                                      "Tidak dapat melakukan transaksi keuangan tertentu, seperti membuka rekening bank, membeli kendaraan bermotor, atau melakukan transaksi jual beli tanah.",
                                                                ),
                                                              ],
                                                            ),
                                                          ),
                                                          ...
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              ...
                                                              children: <TextSpan>[
                                                                TextSpan(
                                                                    text:
                                                                        "Wajib Pajak yang tidak melaporkan NPWP",
                                                                    style: TextStyle(
                                                                        fontWeight:
                                                                            FontWeight.w600)),
                                                                TextSpan(
                                                                  text:
                                                                      " kepada Direktorat Jenderal Pajak (DJP)** akan dikenakan sanksi berupa:",
                                                                ),
                                                              ],
                                                            ),
                                                          ),
                    ...
                    Container(
                      ...
                      child: Container(
                        ...
                        child: FractionallySizedBox(
                          ...
                          widthFactor: 5 / 9, // 20% width of parent
                      ...
                      children: [
                        GestureDetector(
                          onTap: () {
                            Navigator.of(context).pushReplacement(
                              MaterialPageRoute(
                                builder: (context) => MateriNpwp04Page(),
                              ),
                            );
                          },
                          child: SvgPicture.asset(
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.of(context).pushReplacement(
                              MaterialPageRoute(
                                builder: (context) => MateriNpwp06Page(),
                              ),
                            );
                          },
                          child: SvgPicture.asset(
