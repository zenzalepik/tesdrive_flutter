...
class MateriNpwp04Page extends StatefulWidget {
  const MateriNpwp04Page({super.key});

  @override
  State<MateriNpwp04Page> createState() => _MateriNpwp04PageState();
}

class _MateriNpwp04PageState extends State<MateriNpwp04Page> {
  @override
                                                          ...
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              ...
                                                              children: <TextSpan>[
                                                                TextSpan(
                                                                  text:
                                                                      "Sebagai alat untuk melakukan kontrol dan pengawasan terhadap Wajib Pajak.",
                                                                ),
                                                              ],
                                                            ),
                                                          ),
                                                          ...
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              ...
                                                              children: <TextSpan>[
                                                                TextSpan(
                                                                  text:
                                                                      "Sebagai alat untuk mempermudah pemungutan pajak.",
                                                                ),
                                                              ],
                                                            ),
                                                          ),
                                                          ...
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              ...
                                                              children: <TextSpan>[
                                                                TextSpan(
                                                                  text:
                                                                      "Sebagai alat untuk meningkatkan kepatuhan Wajib Pajak.",
                                                                ),
                                                              ],
                                                            ),
                                                          ),
                    ...
                    Container(
                      ...
                      child: Container(
                        ...
                        child: FractionallySizedBox(
                          ...
                          widthFactor: 4/9, // 20% width of parent
