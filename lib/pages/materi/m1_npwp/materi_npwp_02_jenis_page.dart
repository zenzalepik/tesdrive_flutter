...
class MateriNpwp02Page extends StatefulWidget {
  const MateriNpwp02Page({super.key});

  @override
  State<MateriNpwp02Page> createState() => _MateriNpwp02PageState();
}

class _MateriNpwp02PageState extends State<MateriNpwp02Page> {
  @override
                                                    ...
                                                    child: RichText(
                                                      ...
                                                      text: TextSpan(
                                                        ...
                                                        children: <TextSpan>[
                                                          TextSpan(
                                                            text:
                                                                "Diberikan kepada orang pribadi yang melakukan kegiatan usaha, bekerja, menerima penghasilan, atau memiliki penghasilan di atas Penghasilan Tidak Kena Pajak (PTKP).",
                                                          ),
                                                        ],
                                                      ),
                                                    ),
                                                    ...
                                                    child: RichText(
                                                      ...
                                                      text: TextSpan(
                                                        ...
                                                        children: <TextSpan>[
                                                          TextSpan(
                                                            text:
                                                                "Diberikan kepada badan, termasuk persekutuan, yang melakukan kegiatan usaha, menerima penghasilan, atau memiliki penghasilan di atas Penghasilan Tidak Kena Pajak (PTKP).",
                                                          ),
                                                        ],
                                                      ),
                                                    ),
                                                    ...
                                                    child: RichText(
                                                      ...
                                                      text: TextSpan(
                                                        ...
                                                        children: <TextSpan>[
                                                          TextSpan(
                                                            text:
                                                                "Diberikan kepada cabang dari suatu badan yang melakukan kegiatan usaha di tempat lain selain tempat kedudukan pusatnya.",
                                                          ),
                                                        ],
                                                      ),
                                                    ),
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.of(context).pushReplacement(
                              MaterialPageRoute(
                                builder: (context) => MateriNpwp03Page(),
                              ),
                            );
                          },
                          child: SvgPicture.asset(
