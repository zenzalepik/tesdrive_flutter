...
class MateriNpwp07Page extends StatefulWidget {
  const MateriNpwp07Page({super.key});

  @override
  State<MateriNpwp07Page> createState() => _MateriNpwp07PageState();
}

class _MateriNpwp07PageState extends State<MateriNpwp07Page> {
                                                          ...
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              ...
                                                              children: <TextSpan>[
                                                                TextSpan(
                                                                    text:
                                                                        "Tutorial Daftar NPWP Lewat ereg.pajak.go.id",
                                                                    style: TextStyle(
                                                                        fontWeight:
                                                                            FontWeight.w600)),
                                                              ],
                                                          ...
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              ...
                                                              children: <TextSpan>[
                                                                TextSpan(
                                                                    text:
                                                                        "Cara Mudah dan Simple Pemadanan NIK sebagai NPWP",
                                                                    style: TextStyle(
                                                                        fontWeight:
                                                                            FontWeight.w600)),
                                                              ],
                                                          ...
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              ...
                                                              children: <TextSpan>[
                                                                TextSpan(
                                                                    text:
                                                                        "Punya NPWP tidak otomatis bayar pajak",
                                                                    style: TextStyle(
                                                                        fontWeight:
                                                                            FontWeight.w600)),
                                                              ],
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.of(context).pushReplacement(
                              MaterialPageRoute(
                                builder: (context) => MateriNpwp08Page(),
                              ),
                            );
                          },
                          child: SvgPicture.asset(
