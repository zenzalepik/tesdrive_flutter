...
import 'package:belajar_sistem_pajak/pages/materi/m1_npwp/materi_npwp_07_tutorial_page.dart';
import 'package:belajar_sistem_pajak/pages/materi/m1_npwp/materi_npwp_09_sumber_page.dart';
...
class MateriNpwp08Page extends StatefulWidget {
  const MateriNpwp08Page({super.key});

  @override
  State<MateriNpwp08Page> createState() => _MateriNpwp08PageState();
}

class _MateriNpwp08PageState extends State<MateriNpwp08Page> {
  @override
                                                          ...
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              ...
                                                              children: <TextSpan>[
                                                                TextSpan(
                                                                  text:
                                                                      "Persyaratan dan dokumen yang diperlukan untuk mendapatkan kartu NPWP dapat berbeda-beda.",
                                                                ),
                                                              ],
                                                            ),
                                                          ),
                                                          ...
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              ...
                                                              children: <TextSpan>[
                                                                TextSpan(
                                                                  text:
                                                                      "Sebaiknya Anda selalu merujuk pada informasi terbaru dari DJP untuk mengetahui persyaratan dan dokumen yang diperlukan.",
                                                                ),
                                                              ],
                                                            ),
                                                          ),
                    ...
                    Container(
                      ...
                      child: Container(
                        ...
                        child: FractionallySizedBox(
                          ...
                          widthFactor: 8 / 9, // 20% width of parent
                      ...
                      children: [
                        GestureDetector(
                          onTap: () {
                            Navigator.of(context).pushReplacement(
                              MaterialPageRoute(
                                builder: (context) => MateriNpwp07Page(),
                              ),
                            );
                          },
                          child: SvgPicture.asset(
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.of(context).pushReplacement(
                              MaterialPageRoute(
                                builder: (context) => MateriNpwp09Page(),
                              ),
                            );
                          },
                          child: SvgPicture.asset(
