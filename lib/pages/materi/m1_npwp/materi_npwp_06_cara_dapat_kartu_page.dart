...
class MateriNpwp06Page extends StatefulWidget {
  const MateriNpwp06Page({super.key});

  @override
  State<MateriNpwp06Page> createState() => _MateriNpwp06PageState();
}

class _MateriNpwp06PageState extends State<MateriNpwp06Page> {
                    ...
                    Row(
                      ...
                      children: [
                        MarkSubtitle(
                            ...
                            text: "06. Cara Dapatkan Kartu NPWP Secara Online:")
                      ],
                    ),
                    Row(
                                                          ...
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              ...
                                                              children: <TextSpan>[
                                                                TextSpan(
                                                                  text:
                                                                      "Jika verifikasi berhasil, Anda akan menerima kartu NPWP melalui pos.",
                                                                ),
                                                              ],
                                                            ),
                                                          ),
                                                          ...
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              ...
                                                              children: <TextSpan>[
                                                                TextSpan(
                                                                  text:
                                                                      "Download aplikasi e-NPWP di App Store atau Google Play Store.",
                                                                ),
                                                              ],
                                                            ),
                                                          ),
                                                          ...
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              ...
                                                              children: <TextSpan>[
                                                                TextSpan(
                                                                  text:
                                                                      "Jika verifikasi berhasil, Anda akan menerima kartu NPWP secara elektronik (e-NPWP).",
                                                                ),
                                                              ],
                                                            ),
                                                          ),
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.of(context).pushReplacement(
                              MaterialPageRoute(
                                builder: (context) => MateriNpwp05Page(),
                              ),
                            );
                          },
                          child: SvgPicture.asset(
