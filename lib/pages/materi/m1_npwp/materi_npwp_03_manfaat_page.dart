...
class MateriNpwp03Page extends StatefulWidget {
  const MateriNpwp03Page({super.key});

  @override
  State<MateriNpwp03Page> createState() => _MateriNpwp03PageState();
}

class _MateriNpwp03PageState extends State<MateriNpwp03Page> {
  @override
                                                          ...
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              ...
                                                              children: <TextSpan>[
                                                                TextSpan(
                                                                  text:
                                                                      "Memperoleh hak-hak perpajakan, seperti hak untuk mendapatkan restitusi pajak.",
                                                                ),
                                                              ],
                                                            ),
                                                          ),
                                                          ...
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              ...
                                                              children: <TextSpan>[
                                                                TextSpan(
                                                                  text:
                                                                      "Meningkatkan kesadaran masyarakat tentang pajak.",
                                                                ),
                                                              ],
                                                            ),
                                                          ),
