...
class MateriSpt01Page extends StatefulWidget {
  const MateriSpt01Page({super.key});

  @override
  State<MateriSpt01Page> createState() => _MateriSpt01PageState();
}

class _MateriSpt01PageState extends State<MateriSpt01Page> {
  @override
                                        ...
                                        child: RichText(
                                          ...
                                          text: TextSpan(
                                            ...
                                            children: <TextSpan>[
                                              ...
                                              TextSpan(
                                                  text:
                                                      "penghasilan, harta, dan/atau kewajiban",
                                                  style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.bold)),
                                              TextSpan(
                                                text:
                                                    " yang dimiliki dan/atau diperolehnya dalam suatu ",
                                              ),
                                              TextSpan(
                                                  text: "tahun pajak",
                                                  style: TextStyle(
                                              ...
                                              RichText(
                                                ...
                                                text: TextSpan(
                                                  ...
                                                  children: <TextSpan>[
                                                    TextSpan(
                                                      text:
                                                          "SPT Pajak merupakan sarana administrasi perpajakan yang penting untuk:",
                                                    ),
                                                  ],
                                                ),
                                              ),
                                                                ...
                                                                child: RichText(
                                                                  ...
                                                                  text:
                                                                    ...
                                                                    children: <TextSpan>[
                                                                      TextSpan(
                                                                        text:
                                                                            "Mendukung kelancaran pelaksanaan tugas Direktorat Jenderal Pajak (DJP).",
                                                                      ),
                                                                    ],
                                                                  ),
                                                                ),
                    ...
                    Container(
                      ...
                      child: Container(
                        ...
                        child: FractionallySizedBox(
                          ...
                          widthFactor: 1 / 7, // 20% width of parent
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.of(context).pushReplacement(
                              MaterialPageRoute(
                                builder: (context) => MateriSpt02Page(),
                              ),
                            );
                          },
                          child: SvgPicture.asset(
