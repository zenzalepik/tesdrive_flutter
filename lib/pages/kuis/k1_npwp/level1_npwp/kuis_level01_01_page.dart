...
class KuisPageNpwpLevel1Nomor1 extends StatefulWidget {
  const KuisPageNpwpLevel1Nomor1({super.key});

  @override
  State<KuisPageNpwpLevel1Nomor1> createState() =>
      _KuisPageNpwpLevel1Nomor1State();
}

class _KuisPageNpwpLevel1Nomor1State extends State<KuisPageNpwpLevel1Nomor1> {
  ...
  void _loadScore() async {
    ...
    await prefs.setInt('scoreNpwpLevel1', 0);
      ...
      setState(() {
        if (isCorrect) {
          ...
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => KuisPageNpwpLevel1Nomor2()),
          );
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('"C. Automated cross checking"', style: Tulisan.commic()),
              SizedBox(height: 12),
              Row(
