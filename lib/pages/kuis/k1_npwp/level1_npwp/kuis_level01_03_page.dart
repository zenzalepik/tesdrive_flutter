...
import 'package:belajar_sistem_pajak/pages/kuis/k1_npwp/level1_npwp/kuis_level01_04_page.dart';
...
class KuisPageNpwpLevel1Nomor3 extends StatefulWidget {
  const KuisPageNpwpLevel1Nomor3({super.key});

  @override
  State<KuisPageNpwpLevel1Nomor3> createState() =>
      _KuisPageNpwpLevel1Nomor3State();
}

class _KuisPageNpwpLevel1Nomor3State extends State<KuisPageNpwpLevel1Nomor3> {
      ...
      setState(() {
        if (isCorrect) {
          ...
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => KuisPageNpwpLevel1Nomor4()),
          );
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('"A. 31 Desember 2023"', style: Tulisan.commic()),
              SizedBox(height: 12),
              Row(
