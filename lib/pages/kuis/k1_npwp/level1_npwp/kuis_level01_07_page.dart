...
import 'package:belajar_sistem_pajak/pages/kuis/k1_npwp/level1_npwp/kuis_level01_08_page.dart';
...
class KuisPageNpwpLevel1Nomor7 extends StatefulWidget {
  const KuisPageNpwpLevel1Nomor7({super.key});

  @override
  State<KuisPageNpwpLevel1Nomor7> createState() =>
      _KuisPageNpwpLevel1Nomor7State();
}

class _KuisPageNpwpLevel1Nomor7State extends State<KuisPageNpwpLevel1Nomor7> {
      ...
      setState(() {
        if (isCorrect) {
          ...
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => KuisPageNpwpLevel1Nomor8()),
          );
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('"A. Berkala"', style: Tulisan.commic()),
              SizedBox(height: 12),
              Row(
                                              ...
                                              Expanded(
                                                child: Column(
                                                  children: [
                                                    //Soal
                                                    Text(
                                                      "Sistem DJP akan melakukan validasi data pada profil WP dengan data yang ada pada Dukcapil secara…",
