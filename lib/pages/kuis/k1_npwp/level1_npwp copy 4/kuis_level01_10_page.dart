...
import 'package:belajar_sistem_pajak/pages/kuis/k1_npwp/level1_npwp/kuis_level01_11_page.dart';
...
class KuisPageNpwpLevel1Nomor10 extends StatefulWidget {
  const KuisPageNpwpLevel1Nomor10({super.key});

  @override
  State<KuisPageNpwpLevel1Nomor10> createState() =>
      _KuisPageNpwpLevel1Nomor10State();
}

class _KuisPageNpwpLevel1Nomor10State extends State<KuisPageNpwpLevel1Nomor10> {
      ...
      setState(() {
        if (isCorrect) {
          ...
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => KuisPageNpwpLevel1Nomor11()),
          );
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('"D. Data penghasilan"', style: Tulisan.commic()),
              SizedBox(height: 12),
              Row(
                                              ...
                                              Expanded(
                                                child: Column(
                                                  children: [
                                                    //Soal
                                                    Text(
                                                      "Mengingat pentingnya data yang lengkap, maka kita perlu mengimbau wajib pajak untuk bukan saja melakukan pemadanan NIK dan NPWP tetapi juga untuk melengkapi ...",
                              ...
                              children: [
                                GestureDetector(
                                  ...
                                  child: ButtonJawabanAbc(
                                    ...
                                    abjad: 'A',
                                    text_jawaban: 'Data Anggota Keluarga',
                                  ),
                                ),
                              ],
                            ),
                              ...
                              children: [
                                GestureDetector(
                                  ...
                                  child: ButtonJawabanAbc(
                                    ...
                                    abjad: 'B',
                                    text_jawaban: 'Nomor telepon aktif',
                              ...
                              children: [
                                GestureDetector(
                                  ...
                                  child: ButtonJawabanAbc(
                                    ...
                                    abjad: 'C',
                                    text_jawaban: 'Alamat email aktif',
                                  ),
                                ),
                              ],
                            ),
