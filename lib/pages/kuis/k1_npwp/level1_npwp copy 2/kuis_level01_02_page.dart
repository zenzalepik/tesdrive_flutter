...
class KuisPageNpwpLevel1Nomor2 extends StatefulWidget {
  const KuisPageNpwpLevel1Nomor2({super.key});

  @override
  State<KuisPageNpwpLevel1Nomor2> createState() =>
      _KuisPageNpwpLevel1Nomor2State();
}

class _KuisPageNpwpLevel1Nomor2State extends State<KuisPageNpwpLevel1Nomor2> {
      ...
      setState(() {
        if (isCorrect) {
          ...
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => KuisPageNpwpLevel1Nomor3()),
          );
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('"D. 16 digit angka"', style: Tulisan.commic()),
              SizedBox(height: 12),
              Row(
                                              ...
                                              Expanded(
                                                child: Column(
                                                  children: [
                                                    //Soal
                                                    Text(
                                                      "Format NPWP baru untuk badan, instansi pemerintah, dan orang pribadi yang bukan penduduk adalah sebagai berikut…",
                              ...
                              children: [
                                GestureDetector(
                                  ...
                                  child: ButtonJawabanAbc(
                                    ...
                                    abjad: 'A',
                                    text_jawaban:
                                        '16 digit kombinasi angka dan huruf',
                                  ),
                                ),
                              ],
                            ),
                              ...
                              children: [
                                GestureDetector(
                                  ...
                                  child: ButtonJawabanAbc(
                                    ...
                                    abjad: 'B',
                                    text_jawaban:
                                        '15 digit angka dan 1 digit huruf',
