...
import 'package:belajar_sistem_pajak/pages/kuis/k1_npwp/level1_npwp/kuis_level01_07_page.dart';
...
class KuisPageNpwpLevel1Nomor6 extends StatefulWidget {
  const KuisPageNpwpLevel1Nomor6({super.key});

  @override
  State<KuisPageNpwpLevel1Nomor6> createState() =>
      _KuisPageNpwpLevel1Nomor6State();
}

class _KuisPageNpwpLevel1Nomor6State extends State<KuisPageNpwpLevel1Nomor6> {
      ...
      setState(() {
        if (isCorrect) {
          ...
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => KuisPageNpwpLevel1Nomor7()),
          );
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('"A. Profil"', style: Tulisan.commic()),
              SizedBox(height: 12),
              Row(
                                              ...
                                              Expanded(
                                                child: Column(
                                                  children: [
                                                    //Soal
                                                    Text(
                                                      "Untuk melakukan validasi NIK sebagai NPWP bagi WP OP yang sudah memiliki NPWP dapat dilakukan dengan login situs web https://pajak.go.id kemudian memilih menu…",
