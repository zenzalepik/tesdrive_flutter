...
import 'package:belajar_sistem_pajak/pages/kuis/k1_npwp/level1_npwp/kuis_level01_06_page.dart';
...
class KuisPageNpwpLevel1Nomor5 extends StatefulWidget {
  const KuisPageNpwpLevel1Nomor5({super.key});

  @override
  State<KuisPageNpwpLevel1Nomor5> createState() =>
      _KuisPageNpwpLevel1Nomor5State();
}

class _KuisPageNpwpLevel1Nomor5State extends State<KuisPageNpwpLevel1Nomor5> {
      ...
      setState(() {
        if (isCorrect) {
          ...
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => KuisPageNpwpLevel1Nomor6()),
          );
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('"B. Nomor Identitas Domisili Kegiatan Usaha"',
                                              ...
                                              Expanded(
                                                child: Column(
                                                  children: [
                                                    //Soal
                                                    Text(
                                                      "Format NPWP baru untuk NPWP cabang adalah sebagai berikut…",
                              ...
                              children: [
                                GestureDetector(
                                  ...
                                  child: ButtonJawabanAbc(
                                    ...
                                    abjad: 'A',
                                    text_jawaban:
                                        'Nomor ID Tempat Kegiatan Usaha',
                                  ),
                                ),
                              ],
                            ),
                              ...
                              children: [
                                GestureDetector(
                                  ...
                                  child: ButtonJawabanAbc(
                                    ...
                                    abjad: 'B',
                                    text_jawaban:
                                        'Nomor Identitas Domisili Kegiatan Usaha',
                              ...
                              children: [
                                GestureDetector(
                                  ...
                                  child: ButtonJawabanAbc(
                                    ...
                                    abjad: 'D',
                                    text_jawaban:
                                        'Nomor Identitas Kegiatan Usaha WP',
