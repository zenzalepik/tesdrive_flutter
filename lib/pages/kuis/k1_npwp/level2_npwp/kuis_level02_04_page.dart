...
import 'package:belajar_sistem_pajak/pages/kuis/k1_npwp/level1_npwp/kuis_level01_05_page.dart';
...
class KuisPageNpwpLevel1Nomor4 extends StatefulWidget {
  const KuisPageNpwpLevel1Nomor4({super.key});

  @override
  State<KuisPageNpwpLevel1Nomor4> createState() =>
      _KuisPageNpwpLevel1Nomor4State();
}

class _KuisPageNpwpLevel1Nomor4State extends State<KuisPageNpwpLevel1Nomor4> {
      ...
      setState(() {
        if (isCorrect) {
          ...
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => KuisPageNpwpLevel1Nomor5()),
          );
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('"D. 1 Januari 2024"', style: Tulisan.commic()),
              SizedBox(height: 12),
              Row(
                                              ...
                                              Expanded(
                                                child: Column(
                                                  children: [
                                                    //Soal
                                                    Text(
                                                      "Format NPWP baru diterapkan secara menyeluruh pada layanan administrasi perpajakan pada…",
